...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">
            Semua barang tertinggal yang tercatat di sistem
        </p>
    </div>
